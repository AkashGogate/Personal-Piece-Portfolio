...
const bio = [
  ...
  "I like working on problems where the technical details actually matter. You can't shortcut them — you have to actually understand what's going on to solve them.",
  "The goal is to build things that couldn't exist without both solid engineering and thoughtful design, because you need both to get it right. That intersection is where the most interesting problems are, and where I want to spend my career.",
];
