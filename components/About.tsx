...
const bio = [
  "I'm a CS + Biology student at UW-Madison, graduating in May 2027. Right now I'm building LLM agent pipelines for spatial transcriptomics research at the Kendziorski Lab, and my industry experience has been in backend infrastructure and distributed systems at Leidos.",
      ...
      <div className="max-w-7xl mx-auto px-6" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="flex gap-8" style={{ maxWidth: "52rem" }}>
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              3.9 GPA · Dean&apos;s List · CS + Biology, UW-Madison · Graduating May 2027 ·{" "}
              <span style={{ color: "var(--primary)", fontWeight: 500 }}>Open to Summer 2026 internships</span>
            </motion.p>
          </div>
        </div>
      </div>
